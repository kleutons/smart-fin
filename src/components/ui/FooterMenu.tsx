                ...
                <div className="flex justify-between">
                    ...
                    {menuList.map((item, index)=>(
                        ...
                        <item.icon 
                            size={45} 
                            strokeWidth={1} 
                            className={`p-2 rounded-xl text-mainFontBold transition-all duration-300 cursor-pointer ${location.pathname === item.url || firstPart == item.url ? 'bg-mainGreen' : 'bg-mainWhite'}`} 
